...
namespace MassTransit.Transports.AzureServiceBus
{
    ...
    /// </summary>
    public class AzureServiceBusOutboundTransport
        : IOutboundTransport
    {
        const string NumberOfRetries = "busy-retries";
        static readonly ILog _logger = Logger.Get(typeof(AzureServiceBusOutboundTransport));
        ...
        struct StateHolder
        {
            public StateHolder(MessageSender sender, BrokeredMessage message)
                : this()
            {
                Sender = sender;
                Message = message;
