...
namespace MassTransit.Transports.AzureServiceBus
{
    ...
    {
        static readonly ILog _log = Logger.Get<AzureServiceBusConsumer>();
        ...
        public AzureServiceBusConsumer(IAzureServiceBusEndpointAddress address, IInboundSettings inboundSettings)
        {
            _address = address;
        }
